...
assert("inline_display_dollars_recovery", hasKatex(renderer.renderMarkdown(String.raw`Use $$\frac{d}{dx}x^4 = 4x^3$$ in a sentence.`)));
...
assert("inline_legacy_bracket_recovery", hasKatex(renderer.renderMarkdown(String.raw`Use \[\frac{d}{dx}x^4 = 4x^3\] in a sentence.`)));
