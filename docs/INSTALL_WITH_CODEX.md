...
This is a support path for the current source-based release, not the future
desktop download.
...
privacy-safe test suite, and open the local application. Do not provide API keys,
course files, cookies, or university credentials in the request.
